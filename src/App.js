...
function App() { 
  ...
  <div className='h-screen w-full bg-white dark:bg-[#191923]'>
    <div className="container mx-auto  scroll-smooth hover:scroll-auto px-6">
      <div className="h-screen min-h-full flex flex-wrap">
        ...
        <div className="mt-4 mr-4 mb-4 bg-slate-100 rounded-r-sm main relative flex-1 min-h-max overflow-y-auto no-scrollbar h-[95%] hidden md:block">
            
            <div style={myStyle}>  
              <div className="art-top-bg-overlay"></div>
            </div> 
            <div className='px-10 mt-8 min-h-max  overflow-y-auto no-scrollbar h-[95%]'>
              <div className='banner flex flex-col relative '>  
                <MainContent/>
              </div> 
            </div>
        </div>
